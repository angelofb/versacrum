...
2. Eseguire `npm run build` e `npm test`: i controlli coprono anteprima, pubblicazione, URL, sitemap, metadati, riferimenti JSON-LD e browser desktop/mobile. I dati della pubblicazione sono simulati nei test, senza modificare i placeholder del sito.

...
en.home = {
  ...
  stay: {
    ...
    description: ["Everything you need to know", "to picture your days here."],
  ...
  form: {
    ...
    privacyText: "We use the information you provide to reply to your request.",
...
en.dynamic = {
  ...
  emailGreeting: "Hello, I would like to ask about availability at Ver Sacrum.",
...
fr.home = {
  ...
  city: {
    ...
    items: [
      ["Piazza del Popolo", "Le salon de la ville, où revenir à toute heure."],
      [
...
de.home = {
  ...
  form: {
    ...
    privacyText: "Wir verwenden Ihre Angaben, um Ihre Anfrage zu beantworten.",
